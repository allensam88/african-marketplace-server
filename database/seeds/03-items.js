exports.seed = function (knex) {
    return knex('items').insert([
        { name: 'basket', description: 'great for carrying produce', price: 4, category: 'home', location: 'Kampala', itemImg: 'https://tinyurl.com/yzdk8qwo', user_id: 1 },
        ...
        { name: 'chair', description: 'white oak', price: 85, category: 'home', location: 'Mombasa', itemImg: 'https://tinyurl.com/yhzjkohq', user_id: 2 },
        ...
        { name: 'sculpture', description: 'wildlife art', price: 56, category: 'art', location: 'Jinja', itemImg: 'https://tinyurl.com/yf9olscx', user_id: 4 },
        ...
        { name: 'knive set', description: 'hand crafted, wooden handles', price: 99, category: 'home', location: 'Kampala', itemImg: 'https://tinyurl.com/yg6p5nbn', user_id: 6 },
        { name: 'chicken feed', description: '50 lb sack', price: 16, category: 'garden', location: 'Dar es Salaam', itemImg: 'https://tinyurl.com/yzvm786h', user_id: 6 },
        ...
        { name: 'motorbike', description: 'go fast', price: 850, category: 'toys', location: 'Kampala', itemImg: 'https://tinyurl.com/yfqhh87j', user_id: 21 },
